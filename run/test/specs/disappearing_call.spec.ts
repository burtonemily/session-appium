...
iosIt('Disappearing call message 1o1', 'low', disappearingCallMessage1o1, true);
androidIt('Disappearing call message 1o1', 'low', disappearingCallMessage1o1, true);
...
async function disappearingCallMessage1o1(platform: SupportedPlatformsType) {
  ...
  await sleepFor(500);
  await device1.onIOS().clickOnByAccessibilityID('Close button');
