...
export const en = {
  ...
  accountIdCopyDescription:
    'Copy your Account ID then share it with your friends so they can message you.',
  ...
  accountIdShare:
    "Hey, I've been using {app_name} to chat with complete privacy and security. Come join me! My Account ID is<br/><br/>{account_id}<br/><br/>Download it at {session_download_url}",
  ...
  adminPromoteMoreDescription:
    'Are you sure you want to promote <b>{name}</b> and <b>{count} others</b> to admin? Admins cannot be removed.',
  ...
  adminPromotionFailedDescriptionMultiple:
    'Failed to promote {name} and {count} others in {group_name}',
  ...
  appearanceLanguageDescription:
    'Choose your language setting for {app_name}. {app_name} will restart when you change your language setting.',
  ...
  attachmentsAutoDownloadModalDescription:
    'Would you like to automatically download all files from <b>{conversation_name}</b>?',
  attachmentsAutoDownloadModalTitle: 'Auto Download',
  attachmentsClearAll: 'Clear All Attachments',
  attachmentsClearAllDescription:
    'Are you sure you want to clear all attachments? Messages with attachments will also be deleted.',
  ...
  attachmentsErrorTypes:
    'Cannot attach images and video with other file types. Try sending other files in a separate message.',
  ...
  blockDescription:
    'Are you sure you want to block <b>{name}</b>? Blocked users cannot send you message requests, group invites or call you.',
  blockUnblock: 'Unblock',
  blockUnblockName: 'Are you sure you want to unblock <b>{name}</b>?',
  blockUnblockNameMultiple:
    'Are you sure you want to unblock <b>{name}</b> and <b>{count} others</b>?',
  ...
  callsVoiceAndVideoModalDescription:
    'Your IP is visible to your call partner and an Oxen Foundation server while using beta calls.',
  ...
  callsYouMissedCallPermissions:
    "You missed a call from <b>{name}</b> because you haven't enabled <b>Voice and Video Calls</b> in Privacy Settings.",
  ...
  clearDataAllDescription:
    'This will permanently delete your messages and contacts. Would you like to clear this device only, or delete your data from the network as well?',
  clearDataError: 'Data Not Deleted',
  clearDataErrorDescription:
    '{count, plural, one [Data not deleted by # Service Node. Service Node ID: {service_node_id}.] other [Data not deleted by # Service Nodes. Service Node IDs: {service_node_id}.]}',
  clearDataErrorDescriptionGeneric:
    'An unknown error occurred and your data was not deleted. Do you want to delete your data from just this device instead?',
  ...
  clearMessagesChatDescription:
    'Are you sure you want to clear all messages from your conversation with <b>{name}</b> from your device?',
  clearMessagesCommunity:
    'Are you sure you want to clear all <b>{community_name}</b> messages from your device?',
  clearMessagesForEveryone: 'Clear for everyone',
  clearMessagesForMe: 'Clear for me',
  clearMessagesGroupAdminDescription:
    'Are you sure you want to clear all <b>{group_name}</b> messages?',
  clearMessagesGroupDescription:
    'Are you sure you want to clear all <b>{group_name}</b> messages from your device?',
  clearMessagesNoteToSelfDescription:
    'Are you sure you want to clear all Note to Self messages from your device?',
  close: 'Close',
  closeWindow: 'Close Window',
  commitHashDesktop: 'Commit Hash: {hash}',
  communityBanDeleteDescription:
    'This will ban the selected user from this Community and delete all their messages. Are you sure you want to continue?',
  communityBanDescription:
    'This will ban the selected user from this Community. Are you sure you want to continue?',
  ...
  contactDeleteDescription:
    'Are you sure you want to delete <b>{name}</b> from your contacts? New messages from <b>{name}</b> will arrive as a message request.',
  ...
  conversationsDeleteDescription:
    'Are you sure you want to delete your conversation with <b>{name}</b>? New messages from <b>{name}</b> will start a new conversation.',
  ...
  conversationsMessageTrimmingTrimCommunitiesDescription:
    'Delete messages from Community conversations older than 6 months, and where there are over 2,000 messages.',
  ...
  conversationsSendWithEnterKeyDescription:
    'Tapping the Enter Key will send message instead of starting a new line.',
  ...
  databaseErrorGeneric:
    'A database error occurred.<br/><br/>Export your application logs to share for troubleshooting. If this is unsuccessful, reinstall {app_name} and restore your account.<br/><br/>Warning: This will result in loss of all messages, attachments, and account data older than two weeks.',
  databaseErrorTimeout:
    "We've noticed {app_name} is taking a long time to start.<br/><br/>You can continue to wait, export your device logs to share for troubleshooting, or try restarting {app_name}.",
  databaseErrorUpdate:
    'Your app database is incompatible with this version of {app_name}. Reinstall the app and restore your account to generate a new database and continue using {app_name}.<br/><br/>Warning: This will result in the loss of all messages and attachments older than two weeks.',
  ...
  deleteAfterGroupPR1MentionsOnlyDescription:
    "When enabled, you'll only be notified for messages mentioning you.",
  deleteAfterGroupPR1MessageSound: 'Message Sound',
  deleteAfterGroupPR3DeleteMessagesConfirmation:
    'Permanently delete the messages in this conversation?',
  ...
  deleteAfterLegacyDisappearingMessagesTheyChangedTimer:
    '<b>{name}</b> set the disappearing message timer to <b>{time}</b>',
  ...
  disappearingMessagesFollowSettingOn:
    'Set your messages to disappear <b>{time}</b> after they have been <b>{disappearing_messages_type}</b>?',
  ...
  disappearingMessagesSet:
    '<b>{name}</b> has set messages to disappear {time} after they have been {disappearing_messages_type}.',
  disappearingMessagesSetYou:
    '<b>You</b> set messages to disappear {time} after they have been {disappearing_messages_type}.',
  ...
  disappearingMessagesTurnedOffYou:
    '<b>You</b> turned <b>off</b> disappearing messages. Messages you send will no longer disappear.',
  ...
  emojiReactsCountOthers:
    '{count, plural, one [And # other has reacted {emoji} to this message.] other [And # others have reacted {emoji} to this message.]}',
  ...
  emojiReactsHoverTwoNameMultipleDesktop:
    '{name} and <span>{count} others</span> reacted with {emoji_name}',
  emojiReactsHoverYouNameDesktop: 'You reacted with {emoji_name}',
  emojiReactsHoverYouNameMultipleDesktop:
    'You and <span>{count} others</span> reacted with {emoji_name}',
  ...
  giphyWarningDescription:
    '{app_name} will connect to Giphy to provide search results. You will not have full metadata protection when sending GIFs.',
  ...
  groupMemberNewHistoryMultiple:
    '<b>{name}</b> and <b>{count} others</b> were invited to join the group. Chat history was shared.',
  groupMemberNewHistoryTwo:
    '<b>{name}</b> and <b>{other_name}</b> were invited to join the group. Chat history was shared.',
  ...
  groupMemberNewYouHistoryMultiple:
    '<b>You</b> and <b>{count} others</b> were invited to join the group. Chat history was shared.',
  groupMemberNewYouHistoryTwo:
    '<b>You</b> and <b>{name}</b> were invited to join the group. Chat history was shared.',
  ...
  groupOnlyAdmin:
    'You are the only admin in <b>{group_name}</b>.<br/><br/>Group members and settings cannot be changed without an admin.',
  ...
  groupRemoveDescriptionMultiple:
    'Would you like to remove <b>{name}</b> and <b>{count} others</b> from <b>{group_name}</b>?',
  ...
  helpReportABugDescription:
    "Share some details to help us resolve your issue. Export your logs, then upload the file through {app_name}'s Help Desk.",
  helpReportABugExportLogs: 'Export Logs',
  helpReportABugExportLogsDescription:
    "Export your logs, then upload the file through {app_name}'s Help Desk.",
  helpReportABugExportLogsSaveToDesktop: 'Save to desktop',
  helpReportABugExportLogsSaveToDesktopDescription:
    'Save this file to your desktop, then share it with {app_name} developers.',
  helpSupport: 'Support',
  ...
  incognitoKeyboardDescription:
    'Request incognito mode if available. Depending on the keyboard you are using, your keyboard may ignore this request.',
  info: 'Info',
  ...
  linkPreviewsFirstDescription:
    "Display previews for URLs you send and receive. This can be useful, however {app_name} must contact linked websites to generate previews. You can always turn off link previews in {app_name}'s settings.",
  linkPreviewsSend: 'Send Link Previews',
  linkPreviewsSendModalDescription:
    'You will not have full metadata protection when sending link previews.',
  linkPreviewsTurnedOff: 'Link Previews Are Off',
  linkPreviewsTurnedOffDescription:
    "{app_name} must contact linked websites to generate previews of links you send and receive.<br/><br/>You can turn them on in {app_name}'s settings.",
  ...
  membersInviteShareDescription:
    'Would you like to share group message history with <b>{name}</b>?',
  membersInviteShareDescriptionMultiple:
    'Would you like to share group message history with <b>{name}</b> and <b>{count} others</b>?',
  membersInviteShareDescriptionTwo:
    'Would you like to share group message history with <b>{name}</b> and <b>{other_name}</b>?',
  ...
  messageNewDescriptionDesktop:
    "Start a new conversation by entering your friend's Account ID or ONS.",
  messageNewDescriptionMobile:
    "Start a new conversation by entering your friend's Account ID, ONS or scanning their QR code.",
  messageNewYouveGot:
    "{count, plural, one [You've got a new message.] other [You've got # new messages.]}",
  ...
  messageRequestsTurnedOff:
    '<b>{name}</b> has message requests from Community conversations turned off, so you cannot send them a message.',
  ...
  notificationsFastModeDescriptionIos:
    "You'll be notified of new messages reliably and immediately using Apple's notification Servers.",
  ...
  notificationsSlowModeDescription:
    '{app_name} will occasionally check for new messages in the background.',
  ...
  onboardingTosPrivacy:
    'By using this service, you agree to our <b>Terms of Service</b> and <b>Privacy Policy</b>',
  onionRoutingPath: 'Path',
  onionRoutingPathDescription:
    "{app_name} hides your IP by routing your messages through multiple service nodes in {app_name}'s decentralized network. This is your current path:",
  ...
  permissionsKeepInSystemTrayDescription:
    '{app_name} continues running in the background when you close the window',
  permissionsLibrary:
  ...
  recoveryPasswordDescription:
    "Use your recovery password to load your account on new devices.<br/><br/>Your account cannot be recovered without your recovery password. Make sure it's stored somewhere safe and secure — and don't share it with anyone.",
  recoveryPasswordEnter: 'Enter your recovery password',
  recoveryPasswordErrorLoad:
    "An error occurred when trying to load your recovery password.<br/><br/>Please export your logs, then upload the file though Session's Help Desk to help resolve this issue.",
  ...
  recoveryPasswordHidePermanentlyDescription1:
    'Without your recovery password, you cannot load your account on new devices. <br/><br/>We strongly recommend you save your recovery password in a safe and secure place before continuing.',
  ...
  searchMatches:
    '{count, plural, one [{found_count} of # match] other [{found_count} of # matches]}',
  ...
  urlOpenDescription:
    'Are you sure you want to open this URL in your browser?<br/><br/><b>{url}</b>',
